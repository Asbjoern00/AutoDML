...
def run_experiment(data):
    ...
    model_wrapper.train_outcome_head(data, lr=1e-3, wd=1e-3, train_shared_layers=False)
...
estimates.to_csv("doper_neural_nets/results/riesz_informed.csv", index=False)

...
def run_experiment(data, beta):
    ...
    model_wrapper.train_outcome_head(fit, lr=1e-3, train_shared_layers=True, epochs=1000, wd=1e-2, l1=10, batch_size=100)
    model_wrapper.train_riesz_head(fit, lr=1e-3, train_shared_layers=False, epochs=1000, wd=1e-2, batch_size=100)

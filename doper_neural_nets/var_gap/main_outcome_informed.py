...
def run_experiment(data):
    ...
    model_wrapper.train_outcome_head(fit, lr=1e-3, train_shared_layers=True, epochs=1000, wd=1e-3, l1=0.1, batch_size=250)
    model_wrapper.train_riesz_head(fit, lr=1e-3, train_shared_layers=False, epochs=1000, wd=1e-3, batch_size=250)

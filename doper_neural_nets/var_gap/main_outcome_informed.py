...
def run_experiment(data, beta):
    ...
    model_wrapper.train_outcome_head(
        fit, lr=1e-3, train_shared_layers=True, epochs=1000, wd=1e-2, l1=0.25, batch_size=128
    )
    model_wrapper.train_riesz_head(fit, lr=1e-3, train_shared_layers=False, epochs=1000, wd=1e-2, batch_size=128)

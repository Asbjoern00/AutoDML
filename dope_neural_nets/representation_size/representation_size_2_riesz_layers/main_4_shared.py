...
def run_experiment(data):
    estimate_components = []
    model_wrapper = ModelWrapper(in_=25, hidden_size=100, n_shared=4, n_not_shared=1)
...
estimates.to_csv("dope_neural_nets/representation_size/representation_size_2_riesz_layers/4_shared.csv", index=False)

...
def run_experiment(data):
    estimate_components = []
    model_wrapper = ModelWrapper(in_=25, hidden_size=100, n_shared=3, n_not_shared=2, shared_size=10)
...
estimates.to_csv("dope_neural_nets/representation_size/shared_size_experiment/10_shared_neuron.csv", index=False)

...
#e_rmse = mean((no_cross_fit_results$plugin_estimate - no_cross_fit_results$truth)^2)^(1/2)
#e_bias = mean(no_cross_fit_results$plugin_estimate-no_cross_fit_results$truth)


#e_rmse = mean((cross_fit_results$plugin_estimate - no_cross_fit_results$truth)^2)^(1/2)
#e_bias = mean(cross_fit_results$plugin_estimate-no_cross_fit_results$truth)

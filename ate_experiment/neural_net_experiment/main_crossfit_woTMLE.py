...
for rr_weight in rr_weights:
    ...
    if os.path.exists(f"ate_experiment/neural_net_experiment/results/woTMLE/rr_w_{rr_weight}.csv"):
        res = pd.read_csv(f"ate_experiment/neural_net_experiment/results/woTMLE/rr_w_{rr_weight}.csv")

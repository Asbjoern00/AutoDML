library(tidyverse)
library(patchwork)
no_cross_fit_results <- read_csv("ate_experiment/neural_net_experiment/results/no_cross_fit_results.csv")
cross_fit_results <- read_csv("ate_experiment/neural_net_experiment/results/cross_fit_results.csv")

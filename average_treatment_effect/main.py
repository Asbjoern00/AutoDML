...
dragon_net_error = sum(estimate - truth for estimate, truth in zip(estimates, truths)) / K
base_dragon_net = sum(estimate - truth for estimate, truth in zip(base_estimates, truths)) / K
